...
COMMENT ON FUNCTION public.get_judging_live_tag_progression_invariant_admin()
IS 'Admin forensic invariant: proves live judge tag clicks cannot update competition_entries.progression_decision directly, while tag-to-decision mirroring remains installed.';
