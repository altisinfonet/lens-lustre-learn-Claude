...
--   b2c63497a69e780ea68c704e1972d1a1425f71e8c32cabda62c7765d9f2e9380
--
-- The hash is carried here rather than in a separate evidence file so that the
-- record travels with the file.
--
-- Replacement: supabase/rollback/20260910_0032_p32_money_account_control_revoke_ROLLBACK.sql
-- ===========================================================================
DO $withdrawn$ BEGIN
  RAISE EXCEPTION
