-- ═══════════════════════════════════════════════════════════════════════════
-- ROLLBACK for 20260813171159_feed_author_identity.sql
--
...
-- HOW TO RUN
--
--   psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/rollback/20260813171159_feed_author_identity_ROLLBACK.sql
--
