...
--   GRANT EXECUTE ON FUNCTION public.move_to_dlq(text, text, bigint, jsonb) TO PUBLIC, anon, authenticated, ser...
--
-- --------------------------------------------------------------------------
...
--     \i supabase/rollback/20260910_0026_p32mail_move_to_dlq_mail_only_revoke_ROLLBACK.sql
--
