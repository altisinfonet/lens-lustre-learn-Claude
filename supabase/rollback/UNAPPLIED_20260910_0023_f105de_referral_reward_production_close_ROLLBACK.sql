...
--     c135cf08c019e3e19ef89d92601b0a471f24ccd0ce5f559d550b7548329c070f
--
-- The hash is carried here rather than in a separate evidence file so that the
-- record travels with the file.
--
-- Replacement: supabase/rollback/20260910_0024_f105de_referral_reward_production_close_ROLLBACK.sql
-- ===========================================================================
DO $withdrawn$ BEGIN
  RAISE EXCEPTION
    ...
    'preserved below, commented. Replacement: %.', 'supabase/rollback/20260910_0024_f105de_referral_reward_production_close_ROLLBACK.sql'
